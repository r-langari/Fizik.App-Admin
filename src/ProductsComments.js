...
class ProductsComments extends React.Component {
    ...
    constructor (props) {
      ...
      this.state = {
        open: false,
        productsComments: this.props.record.productscomments,
      }
      this.parentId = '';
    ...
    fetchProductsComments = () => {
      ...
      .then((myJson) => {
        this.handleClose();  
        this.setState((state, props) => {
              return {productsComments: myJson};
          });
      })
      .catch((e) => {
          // showNotification('Error: comment not approved', 'warning')
    ...
    render () {
      ...
      for(var i = 0, len = this.state.productsComments.length; i < len; i++) {
        arrElem = this.state.productsComments[i];
                            ...
                            <React.Fragment>
                              ...
                              <Dialog open={this.state.open} onClose={this.handleClose.bind(this)} aria-labelledby="form-dialog-title">
                                ...
                                <DialogActions>
                                  ...
                                  <Button onClick={this.sendReplyToComments.bind(this)} color="primary">
                                      Send
                                  </Button>
                                </DialogActions>
                              </Dialog>
